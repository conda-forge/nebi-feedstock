...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/nebi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nebi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add nebi nebi-cli nebi-desktop
# for installing globally
pixi global install nebi nebi-cli nebi-desktop
```
...
It is possible to list all of the versions of `nebi` available on your platform:
...
```
pixi search nebi --channel conda-forge
```
